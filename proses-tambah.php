...
if(isset($_POST['input']))
{
  ...
  $sql = "INSERT INTO siswa(NIS, Nama, Jurusan, Kelas, Alamat, Nilai_Web, Nilai_PBO, Nilai_Basdat, Nilai_Design, Nilai_Progdas, Rata_rata, Predikat_Nilai, Keterangan)
            VALUES ('$NIS', '$Nama', '$Jurusan', '$Kelas', '$Alamat', '$Nilai_Web', '$Nilai_PBO', '$Nilai_Basdat', '$Nilai_Design', '$Nilai_Progdas', '$Rata_rata', '$Predikat_Nilai', '$Keterangan')";
